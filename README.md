![docker image](https://github.com/CCP-NC/ccpnc-magres-oasis/actions/workflows/docker-publish.yml/badge.svg)
...
2. Clone the repository or download the repository as a zip file.
    ...
    ```sh
    git clone https://github.com/CCP-NC/ccpnc-magres-oasis.git
    cd ccpnc-magres-oasis
    ```

    or

    ```sh
    curl-L -o ccpnc-magres-oasis.zip "https://github.com/CCP-NC/ccpnc-magres-oasis/archive/main.zip"
    unzip ccpnc-magres-oasis.zip
    cd ccpnc-magres-oasis
    ```
...
your `docker-compose.yaml` with `ghcr.io/ccp-nc/ccpnc-magres-oasis:main` for the services
...
By default, no plugins are included in this distribution. You can find a list of available NOMAD plugins [here](https://nomad-lab.eu/prod/v1/oasis/gui/search/plugins). For a list of official plugins provided by FAIRmat, please see [here](https://github.com/CCP-NC/.github/blob/main/profile/README.md). For inspiration, you can also check the list of [plugins that are installed on the production NOMAD deployment hosted by FAIRmat](https://gitlab.mpcdf.mpg.de/nomad-lab/nomad-distro/-/raw/main/pyproject.toml?ref_type=heads).
...
```sh
docker pull ghcr.io/ccp-nc/ccpnc-magres-oasis/jupyter:main
```
...
By default, documentation is built using the [nomad-docs](https://github.com/CCP-NC/nomad-docs) repository. However, if you'd like to customize the documentation for your Oasis instance, you can easily do so.

1. First, [fork the nomad-docs repository](https://github.com/CCP-NC/nomad-docs/fork).
...
_I get an_ `Error response from daemon: Head "https://ghcr.io/v2/CCP-NC/ccpnc-magres-oasis/manifests/main": unauthorized`
